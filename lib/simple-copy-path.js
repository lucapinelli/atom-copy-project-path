...
module.exports = new class {
  ...
  activate() {
    ...
    this.subscriptions.add(atom.commands.add("atom-workspace", {
      ...
      "copy-require-path": (e) => this.copyRequirePath(e)
    }));
  }
  ...
  copyRequirePath(e) {
    const projectPath = this.getProjectRelativePath(this.getTargetEditorPath(e));
    const requirePath = projectPath.replace(/^src\//, '').replace(/\..*/, '');
    atom.clipboard.write(requirePath);
  }
